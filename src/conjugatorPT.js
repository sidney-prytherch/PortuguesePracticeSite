...
class ConjugatorPortuguese {
    ...
    getVerbFormString(verbForm) {
        return this.verbForms[verbForm];
    }

    /**
     * 
     * @param {number} index 
     * @param {*} enabledThirdPersons 
     * @returns string
     */
    getSubject(index, enabledThirdPersons) {
        if (index === 2) {
            let enabledThird = (this.enabledThirdPersonSing.includes(true)) ? this.enabledThirdPersonSing : [true, true, false];
            return random(subjects[index].filter((_, i) => enabledThird[i] ).flat())
        } else if (index === 5) {
            let enabledThird = (this.enabledThirdPersonPlur.includes(true)) ? this.enabledThirdPersonPlur : [true, true, false];
            return random(subjects[index].filter((_, i) => enabledThird[i] ).flat())
        } else {
            return subjects[index][0][0]
        }
    }

    getSubjectWithPerson(person, enabledThirdPersons) {
        let person = switch (person) {
            case Person.FIRST_SING: 1
        }
        return getSubject(
            switch (person) {
                case Person.FIRST_SING : 0
    ...
    private fun getEIStem(infinitive: String, verbLength: Int, stem: String): String {
        if (verbLength > 2) {
            return when (infinitive.substring(verbLength - 3, verbLength)) {
                "car" -> "${infinitive.substring(0, verbLength - 3)}qu"
                "çar" -> "${infinitive.substring(0, verbLength - 3)}c"
                "gar" -> "${infinitive.substring(0, verbLength - 3)}gu"
                else -> stem
            }
        }
        return stem
    ...
    private fun getAOStem(infinitive: String, verbLength: Int, stem: String): String {
        if (verbLength > 2) {
            return when (infinitive.substring(verbLength - 3, verbLength)) {
                "cer", "cir" -> "${infinitive.substring(0, verbLength - 3)}ç"
                "ger", "gir" -> "${infinitive.substring(0, verbLength - 3)}j"
                else -> {
                    return if (
                        verbLength > 3 &&
                        infinitive.substring(verbLength - 4, verbLength) in arrayOf("guir", "guer")
                    ) {
                        infinitive.substring(0, verbLength - 3)
                    } else stem
                }
            }
        }
    ...
    private fun getVerbClassAndStems(infinitive: String, verbLength: Int): VerbData {
        ...
        when {
            ...
            infinitive.endsWith("colorir") -> {
                ...
                verbClass =
                    if (ending == "ar") VerbClass.REG_AR else if (ending == "er") VerbClass.REG_ER else VerbClass.REG_IR
                when {
        ...
        return VerbData(
            verbClass, stem, eAndIStem ?: stem, aAndOStem
    ...
    fun conjugate(
        ...
        verbForms: Array<VerbForm>,
        portugal: Boolean
    ): HashMap<VerbForm, HashMap<Person, String?>> {
        val infinitive = infinitiveUnformatted.lowercase()
        ...
        if (!infinitive.contains(" ") && !infinitive.contains("-") && !infinitive.contains("+") && verbLength > 1 && verbForms.isNotEmpty() && infinitive[verbLength - 1] == 'r') {
            ...
            for (verbForm in verbForms) {
                val conjugatedVerbs = conjugateVerbForm(
                    verbForm,
                    isOrthographicNonAr,
                    isOrthographicAr,
                    verbData,
    ...
    private fun conjugateVerbForm(
        verbForm: VerbForm,
        isOrthographicNonAr: Boolean,
        isOrthographicAr: Boolean,
        verbData: VerbData,
        infinitive: String,
        portugal: Boolean
    ): Array<String?> {
    ...
    private fun conjugatePresInd(
        infinitive: String,
        verbClass: VerbClass,
        presIndStem: String
    ): Array<String?> {
        return when (verbClass) {
            VerbClass.REG_AR -> arrayOf(
                presIndStem + "o",
                presIndStem + "as",
                presIndStem + "a",
                presIndStem + "amos",
            ...
            VerbClass.REG_IR, VerbClass.ABRIR, VerbClass.GANIR, VerbClass.BARRIR, VerbClass.DEF_ORIR, VerbClass.ODIR, VerbClass.ATIR -> arrayOf(
                presIndStem + "o",
                presIndStem + "es",
                presIndStem + "e",
                presIndStem + "imos",
            ...
            VerbClass.TER -> arrayOf(
                presIndStem + "enho",
                if (infinitive == "ter") presIndStem + "ens" else presIndStem + "éns",
                if (infinitive == "ter") presIndStem + "em" else presIndStem + "ém",
                presIndStem + "emos",
                presIndStem + "endes",
                presIndStem + "êm"
            )

            VerbClass.FAZER -> arrayOf(
                presIndStem + "ço",
                presIndStem + "zes",
                presIndStem + "z",
                presIndStem + "zemos",
            ...
            VerbClass.POR2, VerbClass.POR1 -> arrayOf(
                presIndStem + "onho",
                presIndStem + "ões",
                presIndStem + "õe",
                presIndStem + "omos",
            ...
            VerbClass.DIZER, VerbClass.TRAZER -> arrayOf(
                presIndStem + "go",
                presIndStem + "zes",
                presIndStem + "z",
                presIndStem + "zemos",
            ...
            VerbClass.CRER, VerbClass.LER -> arrayOf(
                presIndStem + "eio",
                presIndStem + "ês",
                presIndStem + "ê",
                presIndStem + "emos",
            ...
            VerbClass.DELIR, VerbClass.DESPIR -> arrayOf(
                null,
                presIndStem + "es",
                presIndStem + "e",
                presIndStem + "imos",
            ...
            VerbClass.TUIR, VerbClass.BUIR, VerbClass.STRUIR -> arrayOf(
                presIndStem + "o",
                presIndStem + "is",
                presIndStem + "i",
                presIndStem + "ímos",
            ...
            VerbClass.ERVIR, VerbClass.SERVIR -> arrayOf(
                presIndStem + "irvo",
                presIndStem + "erves",
                presIndStem + "erve",
                presIndStem + "ervimos",
            ...
            VerbClass.PROVER, VerbClass.VER -> arrayOf(
                presIndStem + "ejo",
                presIndStem + "ês",
                presIndStem + "ê",
                presIndStem + "emos",
            ...
            VerbClass.ENGOLIR, VerbClass.OLIR -> arrayOf(
                presIndStem + "ulo",
                presIndStem + "oles",
                presIndStem + "ole",
                presIndStem + "olimos",
    ...
    private fun conjugateImpInd(verbClass: VerbClass, impIndStem: String): Array<String?> {
        return when (verbClass) {
            VerbClass.REG_AR, VerbClass.UINAR, VerbClass.MOBILIAR, VerbClass.RESFOLEGAR, VerbClass.AGUAR, VerbClass.EAR, VerbClass.SAUDAR, VerbClass.IAR, VerbClass.DAR, VerbClass.OIAR -> arrayOf(
                impIndStem + "ava",
                impIndStem + "avas",
                impIndStem + "ava",
                impIndStem + "ávamos",
            ...
            VerbClass.TER, VerbClass.VIR -> arrayOf(
                impIndStem + "inha",
                impIndStem + "inhas",
                impIndStem + "inha",
                impIndStem + "ínhamos",
            ...
            VerbClass.AIR, VerbClass.OER, VerbClass.TUIR, VerbClass.BUIR, VerbClass.STRUIR -> arrayOf(
                impIndStem + "a",
                impIndStem + "as",
                impIndStem + "a",
                impIndStem + "amos",
    ...
    private fun conjugatePretInd(verbClass: VerbClass, pretIndStem: String): Array<String?> {
        return when (verbClass) {
            VerbClass.REG_AR, VerbClass.UINAR, VerbClass.MOBILIAR, VerbClass.RESFOLEGAR, VerbClass.AGUAR, VerbClass.EAR, VerbClass.SAUDAR, VerbClass.IAR, VerbClass.OIAR -> arrayOf(
                pretIndStem + "ei",
                pretIndStem + "aste",
                pretIndStem + "ou",
                pretIndStem + "amos/" + pretIndStem + "ámos",
                pretIndStem + "astes",
                pretIndStem + "aram"
            )

            VerbClass.REG_ER, VerbClass.CRER, VerbClass.VALER, VerbClass.PERDER, VerbClass.LER -> arrayOf(
                pretIndStem + "i",
                pretIndStem + "este",
                pretIndStem + "eu",
                pretIndStem + "emos",
            ...
            VerbClass.TER, VerbClass.ESTAR -> arrayOf(
                pretIndStem + "ive",
                pretIndStem + "iveste",
                pretIndStem + "eve",
                pretIndStem + "ivemos",
            ...
            VerbClass.AIR, VerbClass.TUIR, VerbClass.BUIR, VerbClass.STRUIR -> arrayOf(
                pretIndStem + "í",
                pretIndStem + "íste",
                pretIndStem + "iu",
                pretIndStem + "ímos",
            ...
            VerbClass.DIZER, VerbClass.CABER, VerbClass.HAVER, VerbClass.SABER, VerbClass.TRAZER -> arrayOf(
                pretIndStem,
                pretIndStem + "ste",
                pretIndStem,
                pretIndStem + "mos",
            ...
            VerbClass.IR, VerbClass.SER -> arrayOf(
                pretIndStem + "ui",
                pretIndStem + "oste",
                pretIndStem + "oi",
                pretIndStem + "omos",
    ...
    private fun conjugateSimpPlupInd(verbClass: VerbClass, plupIndStem: String): Array<String?> {
        return when (verbClass) {
            ...
            VerbClass.REG_ER, VerbClass.CRER, VerbClass.VALER, VerbClass.OER, VerbClass.PERDER, VerbClass.PROVER, VerbClass.LER -> arrayOf(
                plupIndStem + "era",
                plupIndStem + "eras",
                plupIndStem + "era",
                plupIndStem + "êramos",
            ...
            VerbClass.TER, VerbClass.FAZER, VerbClass.POR2, VerbClass.DIZER, VerbClass.QUERER, VerbClass.CABER, VerbClass.ESTAR, VerbClass.HAVER, VerbClass.PODER, VerbClass.POR1, VerbClass.TRAZER, VerbClass.VIR, VerbClass.DAR -> arrayOf(
                plupIndStem + "era",
                plupIndStem + "eras",
                plupIndStem + "era",
                plupIndStem + "éramos",
    ...
    private fun conjugatePresSubj(verbClass: VerbClass, presSubjStem: String): Array<String?> {
        return when (verbClass) {
            ...
            VerbClass.DELIR, VerbClass.DESPIR, VerbClass.FALIR -> arrayOf(
                null,
                null,
                null,
                null,
            ...
            VerbClass.GANIR, VerbClass.OLIR, VerbClass.BARRIR, VerbClass.DEF_ORIR, VerbClass.ODIR, VerbClass.ATIR -> arrayOf(
                "{d}$presSubjStem",
                "{d}" + presSubjStem + "s",
                "{d}$presSubjStem",
                "{d}" + presSubjStem + "mos",
            ...
            VerbClass.RESFOLEGAR -> arrayOf(
                presSubjStem + "ólegue",
                presSubjStem + "ólegues",
                presSubjStem + "ólegue",
                presSubjStem + "oleguemos",
                presSubjStem + "olegueis",
                presSubjStem + "oleguem"
            )
    ...
    private fun conjugateImpSubj(verbClass: VerbClass, impSubjStem: String): Array<String?> {
        ...
        return when (verbClass) {
            ...
            VerbClass.TER, VerbClass.FAZER, VerbClass.POR2, VerbClass.DIZER, VerbClass.QUERER, VerbClass.CABER, VerbClass.ESTAR, VerbClass.HAVER, VerbClass.PODER, VerbClass.POR1, VerbClass.SABER, VerbClass.TRAZER, VerbClass.VIR, VerbClass.DAR -> arrayOf(
                impSubjStem + "esse",
                impSubjStem + "esses",
                impSubjStem + "esse",
                impSubjStem + "éssemos",
            ...
            VerbClass.PRAZER -> arrayOf(
                ...
                "{d}" + impSubjStem + "esses",
                impSubjStem + "esse",
                "{d}" + impSubjStem + "éssemos",
                "{d}" + impSubjStem + "ésseis",
                "{d}" + impSubjStem + "essem"
            )
            ...
            VerbClass.DOER -> arrayOf(
                ...
                "{d}" + impSubjStem + "esses",
                impSubjStem + "esse",
                "{d}" + impSubjStem + "êssemos",
                "{d}" + impSubjStem + "êsseis",
                impSubjStem + "essem"
            )
        }
    }
    ...
    private fun conjugateImpAff(
        ...
        return when (verbClass) {
            ...
            VerbClass.REG_IR, VerbClass.UZIR, VerbClass.ABRIR -> arrayOf(
                null,
                impAffStem + "e",
                impAffStem + "a",
                impAffStem + "amos",
            ...
            VerbClass.TER -> arrayOf(
                null,
                if (infinitive == "ter") impAffStem + "em" else impAffStem + "ém",
                impAffStem + "enha",
                impAffStem + "enhamos",
                impAffStem + "ende",
                impAffStem + "enham"
            ...
            VerbClass.CABER, VerbClass.SABER -> arrayOf(
                null,
                impAffStem + "be",
                impAffStem + "iba",
                impAffStem + "ibamos",
            ...
            VerbClass.PROVER, VerbClass.SER, VerbClass.VER -> arrayOf(
                null,
                impAffStem + "ê",
                impAffStem + "eja",
                impAffStem + "ejamos",
            ...
            VerbClass.GANIR -> arrayOf(
                "{d}" + impAffStem + "gana",
                impAffStem + "gane/" + impAffStem + "Normally defective:/" + impAffStem + "ganas",
                "{d}" + impAffStem + "gana",
                "{d}" + impAffStem + "ganamos",
                impAffStem + "gani/" + impAffStem + "Normally defective:/" + impAffStem + "ganais",
                "{d}" + impAffStem + "ganam"
            )
            ...
            VerbClass.OLIR -> arrayOf(
                "{d}" + impAffStem + "ula",
                "{d}" + impAffStem + "ulas",
                "{d}" + impAffStem + "ula",
                "{d}" + impAffStem + "ulamos",
                impAffStem + "oli/" + impAffStem + "Normally defective:/" + impAffStem + "ulais",
                "{d}" + impAffStem + "ulam"
            )
            ...
            VerbClass.BARRIR -> arrayOf(
                "{d}" + impAffStem + "barra",
                impAffStem + "barre/" + impAffStem + "Normally defective:/" + impAffStem + "barras",
                "{d}" + impAffStem + "barra",
                "{d}" + impAffStem + "barramos",
                impAffStem + "barri/" + impAffStem + "Normally defective:/" + impAffStem + "barrais",
                "{d}" + impAffStem + "barram"
            )

            VerbClass.DEF_ORIR -> arrayOf(
                "{d}" + impAffStem + "colora",
                "{d}" + impAffStem + "coloras",
                "{d}" + impAffStem + "colora",
                "{d}" + impAffStem + "coloramos",
                impAffStem + "colori/" + impAffStem + "Normally defective:/" + impAffStem + "colorais",
                "{d}" + impAffStem + "coloram"
            )
            ...
            VerbClass.ODIR -> arrayOf(
                "{d}" + impAffStem + "exploda",
                impAffStem + "explode/" + impAffStem + "Normally defective:/" + impAffStem + "explodas",
                "{d}" + impAffStem + "exploda",
                "{d}" + impAffStem + "explodamos",
                impAffStem + "explodi/" + impAffStem + "Normally defective:/" + impAffStem + "explodais",
                "{d}" + impAffStem + "explodam"
            )

            VerbClass.ATIR -> arrayOf(
                "{d}" + impAffStem + "lata",
                impAffStem + "late/" + impAffStem + "Normally defective:/" + impAffStem + "latas",
                "{d}" + impAffStem + "lata",
                "{d}" + impAffStem + "latamos",
                impAffStem + "lati/" + impAffStem + "Normally defective:/" + impAffStem + "latais",
                "{d}" + impAffStem + "latam"
            )
    ...
    private fun conjugateImpNeg(verbClass: VerbClass, impNegStem: String): Array<String?> {
        return when (verbClass) {
            ...
            VerbClass.REMIR -> arrayOf(
                "{d}$impNegStem",
                "{d}" + impNegStem + "s/" + impNegStem + "/" + impNegStem + "mos/" + impNegStem + "is/" + impNegStem + "m"
            )
    ...
    private class VerbData constructor(
        val verbClass: VerbClass,
        val stem: String,
        val eAndIStem: String,
        val aAndOStem: String,
        val presIndStem: String,
        val impIndStem: String,
        val pretIndStem: String,
        val impAffStem: String,
